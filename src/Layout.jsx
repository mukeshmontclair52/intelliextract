...
import { LayoutDashboard, ArrowLeftRight, Settings, FileSearch, UserPlus, ChevronRight, FolderOpen, FlaskConical, ChevronLeft, Menu, LifeBuoy, BarChart2, Beaker, Play, Cpu } from "lucide-react";
...
const navItems = [
  ...
  { label: "Playground V3", page: "PlaygroundV3", icon: Cpu },
